...
import CanvasBackgroundLayer from '@/components/molecules/canvas/canvas-background-layer'
import CanvasDrawingLayer from '@/components/molecules/canvas/canvas-drawing-layer'
import CanvasImageLayer from '@/components/molecules/canvas/canvas-image-layer'
...
import CanvasContainer from '@/components/organisms/canvas-container/canvas-container'
import App from './app'
